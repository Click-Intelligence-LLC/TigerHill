...
class TestUserCrud:
    ...
    def test_crud_operations(self, adapter, trace_store):
        ...
        try:
            ...
            print(f"✅ CREATE: Created user with ID {created_id}")
            ...
            read_response = adapter.execute(
                trace_id=trace_id,
                method="GET",
                endpoint=f"/api/users/{created_id}"
            )
            ...
            print(f"✅ READ: Retrieved user {created_id}")
            ...
            print(f"✅ UPDATE: Updated user {created_id}")
            ...
            print(f"✅ DELETE: Deleted user {created_id}")
